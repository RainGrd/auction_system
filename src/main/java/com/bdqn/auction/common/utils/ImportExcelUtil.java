...
public class ImportExcelUtil {
    ...
    public static void checkFile(MultipartFile file) throws Exception {
        ...
        /*判断文件名是否符合文件标准*/
        if (!filename.endsWith(ConstantsEnum.XLS.getStr()) && !filename.endsWith(ConstantsEnum.XLSX.getStr())) {
    ...
    public static Workbook getWorkBook(MultipartFile file) throws Exception {
        ...
        if (filename.endsWith(ConstantsEnum.XLS.getStr())) {
            workbook = new HSSFWorkbook(file.getInputStream());
        }
        if (filename.endsWith(ConstantsEnum.XLSX.getStr())) {
